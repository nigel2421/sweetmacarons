  ...
  return (
    <div className="disclaimer-page">
      ...
      <div className="disclaimer-content">
        ...
        <p>
          <b>The deposit to start work the client is required to pay at least 30% of the total Macarons amount to be paid.</b>
        </p>
        ...
        <div className="payment-info">
          ...
          <p>Please share the deposit confirmation message via WhatsApp.</p>
        </div>
